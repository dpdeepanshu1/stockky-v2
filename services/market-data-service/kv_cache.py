...
def _get_neon():
    ...
    (Render cold start + Neon free max connections ≈ 20).
    """
    ...
    with _neon_lock:
        ...
        try:
            ...
            # Free-tier: default pool 1 + overflow 1 (max 2). Cap hard at 2.
            # Prefer Neon *pooler* endpoint (port 6543) over direct (5432).
            ...
            eng = create_engine(
                ...
                connect_args={
                    ...
                    "application_name": "stockky-market-data-kv",
                },
            )
