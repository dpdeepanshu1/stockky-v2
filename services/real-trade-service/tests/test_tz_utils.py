...
real-trade-service round: was 80%, missing lines 85-86, 101, 103, 134-135,
142, 147).
...
(cycle_runner.py, auto_pilot.py, entry_engine.py, manual_engine.py,
main.py's _check_and_expire_gates, auth/dhan_credentials.py) monkeypatches
tz_utils functions away rather than exercising the real ones, so this file
is this module's first direct coverage.
